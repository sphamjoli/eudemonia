...
@genType
and entities = {
    @as("IssuanceAuditReceipt") issuanceAuditReceipt: entityStoreOperations<Entities.IssuanceAuditReceipt.t>,
    @as("IssuanceExecution") issuanceExecution: entityStoreOperations<Entities.IssuanceExecution.t>,
    @as("IssuanceRequest") issuanceRequest: entityStoreOperations<Entities.IssuanceRequest.t>,
    @as("PaymentParticipant") paymentParticipant: entityStoreOperations<Entities.PaymentParticipant.t>,
    @as("Policy") policy: entityStoreOperations<Entities.Policy.t>,
    @as("ProofJob") proofJob: entityStoreOperations<Entities.ProofJob.t>,
    @as("RawEvent") rawEvent: entityStoreOperations<Entities.RawEvent.t>,
    @as("SettlementNote") settlementNote: entityStoreOperations<Entities.SettlementNote.t>,
    @as("TokenTransfer") tokenTransfer: entityStoreOperations<Entities.TokenTransfer.t>,
    @as("WorkerPrivacyConfiguration") workerPrivacyConfiguration: entityStoreOperations<Entities.WorkerPrivacyConfiguration.t>,
  }
  ...
  let entities = {
      issuanceAuditReceipt: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.IssuanceAuditReceipt)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.IssuanceAuditReceipt.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      issuanceExecution: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.IssuanceExecution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.IssuanceExecution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      issuanceRequest: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.IssuanceRequest)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.IssuanceRequest.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      paymentParticipant: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PaymentParticipant)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PaymentParticipant.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      policy: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Policy)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Policy.t,
            >
      ...
      proofJob: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ProofJob)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ProofJob.t,
            >
      ...
      rawEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.RawEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.RawEvent.t,
            >
      ...
      settlementNote: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.SettlementNote)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.SettlementNote.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      tokenTransfer: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TokenTransfer)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TokenTransfer.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      workerPrivacyConfiguration: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.WorkerPrivacyConfiguration)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.WorkerPrivacyConfiguration.t,
            >
          ),
          ~getKey=({id}) => id,
        )
